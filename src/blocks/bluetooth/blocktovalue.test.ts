...
describe('bluetooth state factories', () => {
  ...
  test('should be able generate state for bluetooth setup block', () => {
    ...
    expect(objectKeys(state3.variables).length).toBe(2);
    expect(
    ...
    expect(objectKeys(state5.variables).length).toBe(2);
    expect(
    ...
    expect(objectKeys(state6.variables).length).toBe(2);
    expect(
    ...
    expect(objectKeys(state7.variables).length).toBe(2);
    expect(
